...
export const notificationsFrCA = {
  ...
  'notifications.action.open_settings': 'Ouvrir les paramètres du téléphone',
  'notifications.action.retry': 'Réessayer de configurer les rappels',
  'notifications.action.back_to_settings':
    'Retour aux paramètres des notifications',
  ...
  'notifications.status.not_ready': 'Pas prêts',
  ...
  'notifications.granted.body':
    'Choisissez les rappels que vous souhaitez recevoir dans les paramètres des notifications.',
  ...
  'notifications.notice.check_failed.title':
    'Impossible de vérifier les paramètres de notification',
  ...
  'notifications.notice.settings_opening.title':
    'Les paramètres du téléphone vont s’ouvrir',
