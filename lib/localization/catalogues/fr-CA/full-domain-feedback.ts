...
export const fullDomainFeedbackFrCA = {
  ...
  'domain.error.review':
    'Échec de la révision. Réessayez ou contactez le soutien.',
  ...
  'domain.error.title.review': 'Erreur de révision',
  ...
  'domain.error.camera_permissions_body':
    "Assurez-vous que Menta a la autorisation d'accès à la caméra dans les paramètres de votre appareil.",
  ...
  'domain.action.open_settings': 'Ouvrir Paramètres',
  ...
  'domain.monitoring.group_name_exists':
    'Un groupee avec ce nom existe déjà. Choisissez un nom différent',
  ...
  'domain.monitoring.permission_denied':
    "Vous n'êtes pas autorisé à effectuer cette action. Veuillez vérifier les paramètres.",
  ...
  'domain.monitoring.usage_limit':
    'Vous avez atteint votre limite de utilisation. Démarrer Pro pour plus de promesses et de groupees, ainsi que des abonnements mensuels Momenta.',
  ...
  'domain.oauth.google_unavailable':
    "L’authentification avec Google n'est pas disponible dans cette version de Menta. Utilisez un courriel.",
  'domain.oauth.google_finish':
    "Authentification avec Google n'a pas pu se finaliser. Réessayez.",
  'domain.oauth.apple_unavailable':
    "L’authentification avec Apple n'est pas disponible sur ce appareil. Utilisez un courriel.",
  ...
  'domain.oauth.google_failed':
    "Authentification avec Google n'a pas pu se finaliser. Réessayez ou utilisez un courriel.",
  'domain.oauth.google_already_open':
    'Authentification avec Google est déjà ouverte.',
  'domain.oauth.google_device_unavailable':
    "Authentification avec Google n'est pas disponible sur ce appareil. Utilisez un courriel.",
  'domain.oauth.google_open':
    "Authentification Google n'a pas réussi. Réessayez ou utilisez le courriel.",
  ...
  'domain.oauth.google_unauthorised':
    "Authentification Google n'a pas été autorisée. Réessayez ou utilisez le courriel.",
  'domain.oauth.google_return':
    "Authentification Google n'a pas été finie. Réessayez ou utilisez le courriel.",
  'domain.oauth.apple_open':
    "Authentification Apple n'a pas réussi. Réessayez ou utilisez le courriel.",
  ...
  'domain.oauth.apple_unauthorised':
    "Authentification Apple n'a pas été autorisée. Réessayez ou utilisez le courriel.",
  'domain.oauth.apple_return':
    "Authentification Apple n'a pas été finie. Réessayez ou utilisez le courriel.",
  'domain.edge.failed':
    "S'agissant de {functionName}, quelque chose a échoué. Veuillez réessayez.",
  'domain.edge.maintenance_failed':
    'Opération de maintenance a échouée. Veuillez contacter le soutien si cette situation persiste.',
  ...
  'domain.events.photo_arrival_unknown':
    "Nous ne pouvons pas déterminer s'il a bien reçu cette photo. Vérifiez cette photo avant de ré- envoyer une photo.",
  ...
  'domain.eventStore.publishing_account_changed':
    "Vous avez changé d'identités pendant que Menta a publié cet événement. Signez-vous à nouveau sur l'ancienne compte et vérifiez cette même photo de cet événement.",
  ...
  'domain.eventStore.prepare_photo_account_changed':
    "Vous avez changé d'accounts avant que Menta puisse préparer l'image de l'événement.",
  'domain.eventStore.send_photo_account_changed':
    "Vous avez changé d'accounts avant que Menta puisse envoyer l'image de l'événement.",
  'domain.eventStore.checking_photo_arrival':
    "Vous avez changé d'accounts pendant que Menta vérifiait si l'image arrivait.",
  'domain.eventStore.photo_status_updating':
    "Vous avez changé d'accounts pendant que l'état de l'image de l'événement était mis à jour.",
  'domain.eventStore.event_open_account_changed':
    "Vous avez changé d'accounts pendant que l'image de l'événement était ouverte. Réessayez.",
  'domain.eventStore.event_load_account_changed':
    "Vous avez changé d'accounts pendant que l'image de l'événement était chargée. Réessayez.",
  'domain.eventStore.details_open_account_changed':
    "Vous avez changé d'accounts pendant que les détailss de l'événement étaient ouverts. Réessayez.",
  'domain.eventStore.details_load_account_changed':
    "Vous avez changé d'accounts pendant que les détailss de l'événement étaient chargés. Réessayez.",
  'domain.eventStore.album_open_account_changed':
    "Vous avez changé d'accounts pendant que l'album des invités était ouvert. Réessayez.",
  ...
  'domain.eventStore.album_load_account_changed':
    "Vous avez changé d'accounts pendant que l'album des invités était chargé. Réessayez.",
  'domain.eventStore.review_open_account_changed':
    "Vous avez changé d'accounts pendant que la révision de l'organisateur était ouverte. Réessayez.",
  ...
  'domain.eventStore.review_load_account_changed':
    "Vous avez changé d'accounts pendant que la récapitulation de l'événement était en cours. Réessayez.",
  'domain.eventStore.recap_open_account_changed':
    "Vous avez changé d'accounts pendant que la récapitulation de l'événement était ouverte. Réessayez.",
  ...
  'domain.eventStore.join_start_account_changed':
    "Vous avez changé d'accounts avant que l'événement ne commençât. Réessayez.",
  'domain.eventStore.join_save_account_changed':
    "Vous avez changé d'accounts avant de rejoindre commencé. Réessayez.",
  'domain.eventStore.leave_start_account_changed':
    "Vous avez changé d'accounts avant de quitter commencé. Réessayez.",
  'domain.eventStore.leave_update_account_changed':
    "Vous avez changé d'accounts pendant que Menta était enregistrant votre place. Veuillez réinsérer et vérifier l'inscription.",
  'domain.eventStore.checkin_start_account_changed':
    "Vous avez changé d'accounts avant que la photo du groupee ne soit envoyée. Réessayez.",
  'domain.eventStore.checkin_finish_account_changed':
    "Vous avez changé d'accounts pendant que la photographie du groupee était en cours. Réessayez.",
  ...
  'domain.eventStore.photo_status_check_account_changed':
    "Vous avez changé d'accounts pendant que l'état de photo sauvegardée était en cours d'actualisation. Signez-vous à nouveau et vérifiez la photo.",
  'domain.eventStore.saved_photo_continue_account_changed':
    "Vous avez changé d'accounts avant que la sauvegarde photo ne puisse continuer. Réessayez.",
  ...
  'domain.eventStore.saved_photo_status_account_changed':
    "Vous avez changé d'accounts pendant que l'état des photos sauvegardées était en cours d'actualisation. Signez-vous à nouveau et vérifiez la photo.",
  'domain.eventStore.saved_photos_status_account_changed':
    "Vous avez changé d'accounts pendant que les états des photos sauvegardées étaient en cours d'actualisation.",
  'domain.eventStore.photo_review_start_account_changed':
    "Vous avez changé d'accounts avant que la décision photo ne commence. Réessayez.",
  'domain.eventStore.photo_decision_account_changed':
    "Vous avez changé d'accounts pendant que la décision photo était en cours d'actualisation. Vérifiez la photo avant de décider à nouveau.",
  'domain.eventStore.organiser_decision_start_account_changed':
    "Vous avez changé d'accounts avant que la décision de la photo ne commence. Réessayez.",
  'domain.eventStore.organiser_decision_account_changed':
    "Vous avez changé d'accounts pendant que la décision de la photo était en cours d'actualisation. Vérifiez la photo avant de décider à nouveau.",
  ...
  'domain.handoff.referral_saved': 'Code de référance sauvegardé',
  ...
  'domain.report.nothing_sent': "Aucune réponse de soutien n'a été envoyée.",
  'domain.report.sending': 'Envoyer la révision',
  'domain.report.waiting_confirmation':
    'Menta attend que le serveur confirme cette exacte révision.',
  'domain.report.not_sent': "La révision n'a pas été envoyée",
  'domain.report.remains_on_phone':
    "La révision reste sur cette application. Aucune réponse de soutien n'a été envoyée.",
  'domain.report.result_unknown': 'La réponse à la révision est inconnue',
  'domain.report.could_not_confirm':
    'Menta ne peut pas confirmer la réponse du serveur. Retournez utiliser le même identifiant de révision.',
  'domain.report.received': 'La révision a été reçue',
  'domain.report.confirmed':
    'Menta a confirmé que la révision a été envoyée au serveur.',
  ...
  'domain.commitment.move_daily_verification':
    "Envoie-moi une photo claire après avoir fini. Elle indique la façon dont tu as fait la marche, l'exercice, la route, la matrice, le gymnase ou le résultat.",
  'domain.commitment.move_daily_submission':
    "Explicite ce que tu as fait aujourd'hui et combien de temps tu as passé en mouvement.",
  ...
  'domain.commitment.focused_study_description':
    "Terminez une séance d'étude concentrée chaque jour et note ce que tu as travaillé.",
  ...
  'domain.commitment.focused_study_verification':
    "Noter ce que tu as étudié, combien de temps tu as consacré à l'étude et une chose que tu comprends mieux maintenant.",
  'domain.commitment.focused_study_submission':
    'Étudier un sujet, combien de temps de concentration et une chose que tu comprends mieux maintenant.',
  ...
  'domain.commitment.sleep_reset_group': 'Réinitialisation du sommeil groupee',
  'domain.commitment.no_sugar': 'Aucune bande passante de sucre',
  ...
  'domain.commitment.no_sugar_group': 'Groupee sans ajout de sucre',
  ...
  'domain.commitment.creative_minutes_group': 'Groupee de minutes créatives',
  'domain.intensity.flexible': 'Fini',
  ...
  'domain.notifications.channel_groups':
    'Vos rapports, vérification de vérification requise et changements de groupee',
  'domain.notifications.channel_progress': 'Série, badge, marqué et Menteurs',
  ...
  'domain.notifications.group_milestone_reached': 'Marque de groupee atteinte',
  'domain.notifications.proof_due': 'La preuve est due',
  'domain.notifications.proof_for':
    'Envoyez la preuve pour « {challengeTitle} ».',
  'domain.notifications.group_milestone': 'Marque de groupee atteinte',
  'domain.notifications.group_activity': 'Nouveau groupee d’activité',
  'domain.notifications.group_activity_named':
    '{memberName} a une mise à jour dans {groupName}',
  'domain.notifications.proof_due_for':
    'Le soutien est nécessaire pour "{challengeTitle}"',
  'domain.notifications.proof_due_promise':
    'Le soutien est nécessaire pour votre promesse',
  'domain.notifications.open_update': 'Ouvrez Menta pour voir l’update.',
  ...
  'domain.notifications.review_needed':
    'Le soutien est nécessaire pour votre révision',
  'domain.notifications.proof_waiting':
    'Le soutien est nécessaire pour votre révision en cours',
  ...
  'domain.notifications.group_update': 'Mise à jour du groupee',
  'domain.notifications.group_attention': "Groupee attendu d'attention",
  ...
  'domain.notifications.group_submissions': 'Postes de groupee',
  'domain.notifications.members': 'Membres',
  'domain.notifications.review': 'révision',
  'domain.notifications.reviews': 'révisions',
