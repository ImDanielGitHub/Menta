/** Shared customer-facing UI copy for Mexican Spanish. */
import type { EnglishCatalogue } from '@/lib/localization/en-NZ';

type FullSharedUiKey = Extract<keyof EnglishCatalogue, `shared.${string}`>;

export const fullSharedUiEsMX = {
  ...
  'shared.action.openSettings': 'Abrir configuración',
  ...
  'shared.oauth.providerUnavailable':
    'Iniciar sesión con {provider} no está disponible aquí. Usa el correo en tu lugar.',
  'shared.oauth.providerFailed':
    'No se pudo iniciar sesión con {provider}. Inténtalo de nuevo o utiliza el correo en tu lugar.',
  'shared.oauth.cancelled.title': 'Inicio de sesión cancelado',
  'shared.oauth.cancelled.message':
    'Aún no has iniciado sesión. Elige Apple, Google o correo para volver a intentarlo.',
  ...
  'shared.systemSettings.return.description':
    'Abrir la configuración del celular no confirma que haya cambiado un permiso.',
  ...
  'shared.adTracking.education.body':
    'Menta puede decirle a Meta cuando alguien que vio un anuncio luego se registra, crea un grupo, crea una promesa o invita a un amigo. Tu celular le pedirá permiso a continuación. Puedes rechazarlo y seguir usando Menta.',
  'shared.adTracking.continueHint':
    'Abre el mensaje de permiso de seguimiento de tu celular',
  'shared.adTracking.continue': 'Continuar hasta el mensaje del celular',
  ...
  'shared.camera.notSentYetPhone':
    'Aún no se ha enviado nada. Tu prueba permanece en tu celular hasta que decida enviarla.',
  ...
  'shared.camera.retakeHintPhone':
    'Vuelve a realizarlo si la acción completada no está clara. Esta copia permanece en tu celular hasta que la envíe.',
  ...
  'shared.camera.reopenSavedProofFailed':
    'Menta no pudo reabrir la prueba guardada en este celular.',
  ...
  'shared.camera.proofUploadFailed':
    'La prueba no fue cargada. Tu captura guardada todavía está en este celular.',
