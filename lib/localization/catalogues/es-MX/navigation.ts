...
export const navigationEsMX = {
  ...
  'navigation.create.solo.description':
    'Una promesa. Un plazo para enviar la prueba. Por ahora, sin presión de grupo.',
  ...
  'navigation.create.group.description':
    'Invita a otras personas cuando tengas claro cómo funcionará el ciclo de pruebas.',
