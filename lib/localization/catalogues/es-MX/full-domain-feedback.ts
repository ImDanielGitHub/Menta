/** Mexican Spanish copy for lower-level domain helpers that can reach a person. */
...
export const fullDomainFeedbackEsMX = {
  ...
  'domain.error.connection_tips_body':
    'Intenta cambiar entre WiFi y datos celulares, o muévase a un área con mejor señal.',
  'domain.error.camera_permissions': 'Permisos de cámara',
  'domain.error.camera_permissions_body':
    'Asegúrate de que Menta tenga acceso a la cámara en la configuración de tu dispositivo.',
  ...
  'domain.action.open_settings': 'Abrir configuración',
  ...
  'domain.challenge.proof_default.mindfulness.photo':
    'Toma una fotografía del lugar o configuración que utilizaste para la práctica.',
  ...
  'domain.oauth.google_unavailable':
    'Iniciar sesión con Google no está disponible en esta versión de Menta. Usa el correo en tu lugar.',
  ...
  'domain.oauth.apple_unavailable':
    'Iniciar sesión con Apple no está disponible en este dispositivo. Usa el correo en tu lugar.',
  ...
  'domain.oauth.google_failed':
    'No se pudo iniciar sesión con Google. Inténtalo de nuevo o utiliza el correo.',
  'domain.oauth.google_already_open':
    'El inicio de sesión de Google ya está abierto.',
  'domain.oauth.google_device_unavailable':
    'El inicio de sesión de Google no está disponible en este dispositivo. Usa el correo en tu lugar.',
  'domain.oauth.google_open':
    'No se pudo abrir el inicio de sesión de Google. Inténtalo de nuevo o utiliza el correo.',
  ...
  'domain.oauth.google_unauthorised':
    'El inicio de sesión de Google no fue autorizado. Inténtalo de nuevo o utiliza el correo.',
  'domain.oauth.google_return':
    'No se pudo finalizar el inicio de sesión de Google. Inténtalo de nuevo o utiliza el correo.',
  'domain.oauth.apple_open':
    'No se pudo abrir el inicio de sesión de Apple. Inténtalo de nuevo o utiliza el correo.',
  ...
  'domain.oauth.apple_unauthorised':
    'El inicio de sesión de Apple no fue autorizado. Inténtalo de nuevo o utiliza el correo.',
  'domain.oauth.apple_return':
    'No se pudo finalizar el inicio de sesión de Apple. Inténtalo de nuevo o utiliza el correo.',
  'domain.edge.failed':
  ...
  'domain.handoff.referral_finish_description':
    'Finalice la configuración y Menta comprobará si el código califica para una recompensa.',
  'domain.handoff.referral_setup_description':
    'Crea tu cuenta y Menta verificará el código después de la configuración.',
  ...
  'domain.handoff.finish_setup': 'Finalizar la configuración',
  ...
  'domain.report.draft_saved': 'Borrador guardado en este celular',
  ...
  'domain.report.remains_on_phone':
    'Tu informe permanece en este celular. No se entregó nada al soporte.',
