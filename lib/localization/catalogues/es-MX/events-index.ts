...
export const eventsIndexEsMX = {
  ...
  'events.index.capacity.full': 'Cupo lleno',
  'events.index.capacity.remaining': 'Quedan {count} lugares',
  'events.index.capacity.remaining.one': 'Queda {count} lugar',
  'events.index.capacity.remaining.other': 'Quedan {count} lugares',
  ...
  'events.index.organiser_hint':
    'Abre el enlace del evento y el código de registro del organizador guardado en este celular',
