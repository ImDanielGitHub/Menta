...
export const foundationEsES = {
  ...
  'screenshot.03': 'Confirma cuando hayas terminado.',
  'screenshot.04': 'Pide a alguien que te ayude a rendir cuentas.',
  'screenshot.05': 'Organiza tus eventos en Menta.',
  'screenshot.06': 'Usa Momenta para proteger tu racha.',
  'accessibility.back': 'Atrás',
