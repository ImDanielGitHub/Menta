...
export const fullGroupsEsES = {
  ...
  'groups.tab.code_saved': 'El código {code} está guardado en este teléfono.',
  ...
  'groups.tab.offline_detail':
    'Estos son los últimos grupos guardados en este teléfono. Conéctese en línea antes de unirse, abandonar o cambiar un grupo.',
  ...
  'groups.create.load_error': 'No se pudo cargar la ajustes.',
  ...
  'groups.create.reminders_detail':
    'Permitir recordatorios de revisiones para este grupo. Los miembros aún controlan las notificaciones en tus teléfonos.',
  'groups.create.your_group': 'tu grupo',
  'groups.create.review_outcome':
    'Crear el grupo te convierte en tu primer miembro. Nadie más se une hasta que les envías una invitación y luego puedes cambiar el nombre y la ajustes.',
  ...
  'groups.create.draft_saved': 'Borrador guardado en este teléfono',
  ...
  'groups.create.exit_setup': 'Salir de la ajustes',
  ...
  'groups.create.limits_detail':
    'Tu borrador permanece en este teléfono mientras finaliza esta verificación.',
  ...
  'groups.admin.reminders_detail':
    'Los miembros deben permitir las notificaciones en tu teléfono.',
  ...
  'groups.admin.settings_permission_detail':
    'Sólo los propietarios y administradores pueden gestionar esta ajustes de grupo.',
  ...
  'groups.admin.loading_settings': 'Cargando ajustes de grupo',
  ...
  'groups.board.added_proof_count': '{count} de {total} añadieron una prueba',
  ...
  'groups.board.saved_proof_missing':
    'El estado de prueba de hoy no se guardó en este teléfono.',
  ...
  'groups.join.scan_prompt':
    'Apunte tu teléfono al cartel de invitación o al código QR.',
  'groups.join.preview_intro':
    'Al entrar un código solo se obtiene una vista previa del grupo.',
  'groups.join.preview_free':
    'Unirte por primera vez es gratis, ya sea a una promesa o a un grupo. Verás cualquier coste antes de confirmar.',
  ...
  'groups.join.receipt.free_detail':
    'Te has unido gratis. Abre el grupo para ver sus promesas.',
  ...
  'groups.share.choose_where_detail':
    'Elige una persona o aplicación en la menú para compartir de tu teléfono.',
  ...
  'groups.source.accountability.saved_group_picker.empty_detail':
    'Crea primero un grupo y vuelve para añadir esta promesa.',
  ...
  'groups.source.accountability.saved_group_picker.unknown_detail':
    'Puede que Menta haya añadido la promesa. Compruébalo de nuevo con la misma solicitud antes de intentar otra cosa.',
  ...
  'groups.source.accountability.saved_group_picker.failed_detail':
    'No se ha compartido nada. Elige otro grupo o cierra esta ventana.',
  ...
  'groups.source.accountability.saved_group_picker.create_handoff_failed_title':
    'No se ha podido abrir la configuración del grupo',
  ...
  'groups.create.promise_link.missing_context_detail':
    'Vuelve a la promesa y abre de nuevo la configuración del grupo. No se ha creado ningún grupo.',
  'groups.create.promise_link.confirmed_accessibility':
    'Se ha creado {group} y ahora incluye tu promesa.',
  'groups.create.promise_link.linking_title': 'Añadiendo tu promesa…',
  'groups.create.promise_link.linking_detail':
    '{group} está listo. Menta está confirmando el vínculo de la promesa.',
  'groups.create.promise_link.linking_button': 'Añadiendo promesa…',
  'groups.create.promise_link.unknown_title':
    'Grupo creado. Hay que comprobar el vínculo.',
  'groups.create.promise_link.unknown_detail':
    '{group} está listo, pero Menta no ha podido confirmar si se añadió la promesa. Compruébalo de nuevo con la misma solicitud.',
  'groups.create.promise_link.failed_title':
    'Grupo creado. Promesa no añadida.',
  'groups.create.promise_link.failed_detail':
    '{group} está listo y no se ha compartido nada. Vuelve a la promesa para elegir el siguiente paso.',
  'groups.create.promise_link.check_again': 'Comprobar el vínculo',
