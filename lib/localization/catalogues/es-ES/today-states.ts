...
export const todayStatesEsES = {
  ...
  'today.state.action.make_promise': 'Hacer una promesa',
  ...
  'today.state.offline.detail':
    'Menta no puede actualizar tus promesas ahora mismo. Nada ha cambiado en este teléfono.',
  ...
  'today.state.returning.detail':
    '{awayCopy} Nada está oculto y no te espera ninguna pantalla para hacerte sentir mal. Elige un pequeño paso para volver.',
  ...
  'today.state.proof_due.video_detail':
    'Añade el vídeo que acordaste. Solo será visible para esta promesa y quien la revisa.',
  'today.state.proof_due.video_action': 'Añadir vídeo como prueba',
  'today.state.proof_due.photo_detail':
    'Añade la foto que acordaste. Solo será visible para esta promesa y quien la revisa.',
  'today.state.proof_due.photo_action': 'Añadir foto como prueba',
  'today.state.proof_due.risk_title': 'Hoy todavía cuenta.',
  'today.state.proof_due.streak_risk_detail':
    'Tu racha de {streak} sigue activa. Intenta añadir {proofNoun} antes de las {dueLabel}. La prueba cuenta hasta medianoche.',
  'today.state.proof_due.risk_detail':
    'Intenta añadir {proofNoun} antes de las {dueLabel}. La prueba cuenta hasta medianoche.',
  ...
  'today.state.saved.failed_title': 'La prueba se quedó en este teléfono.',
  ...
  'today.state.saved.failed_detail':
    'Comprueba la conexión y vuelve a intentarlo. El original se queda en este teléfono.',
  ...
  'today.state.group_risk.named_title': '{group} necesita un seguimiento.',
  'today.state.group_risk.title': 'Un grupo necesita un seguimiento.',
  'today.state.group_risk.named_detail':
    'Abre el grupo para ver qué está pendiente.',
  'today.state.group_risk.detail':
    'Abre el grupo para ver quién necesita hacer el seguimiento.',
