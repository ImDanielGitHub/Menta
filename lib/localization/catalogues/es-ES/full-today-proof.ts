 ...
 * frases traducidas.
 */
export const fullTodayProofEsES = {
  ...
  'todayProof.create.draft_not_saved_detail':
    'Menta no pudo guardar este borrador en este teléfono. Quédate aquí e inténtalo de nuevo.',
  ...
  'todayProof.create.finish_first':
    'Primero termina esta ajustes. Puedes crear o unirte a un grupo después.',
  ...
  'todayProof.create.private_on_phone':
    'Sigue siendo privado en este teléfono hasta que lo crees.',
  ...
  'todayProof.promise.check_action_unavailable':
    'Menta todavía no puede comprobar esta acción. Actualiza la promesa antes de volver a intentarlo.',
  'todayProof.promise.leave_result_unknown':
    'Menta no pudo confirmar si abandonaste esta promesa. Comprueba su estado antes de volver a intentarlo.',
  'todayProof.promise.leave_check_unavailable':
    'Menta todavía no puede comprobar si abandonaste esta promesa. Actualiza la promesa antes de volver a intentarlo.',
  'todayProof.promise.result_mismatch':
    'Menta no pudo asociar este resultado con la promesa. Comprueba su estado antes de volver a intentarlo.',
  'todayProof.promise.confirmation_mismatch':
    'Menta no pudo asociar esta confirmación con la promesa. Comprueba su estado antes de volver a intentarlo.',
  'todayProof.promise.leave_receipt_mismatch':
    'Menta no pudo asociar el resultado de salida con esta promesa. Comprueba la promesa antes de volver a intentarlo.',
  'todayProof.promise.already_left':
    'Menta confirmó que ya habías abandonado esta promesa.',
  'todayProof.promise.delete_result_unknown':
    'Menta no pudo confirmar si esta promesa se eliminó. Comprueba su estado antes de volver a intentarlo.',
  'todayProof.promise.delete_check_unavailable':
    'Menta todavía no puede comprobar si esta promesa se eliminó. Actualiza tus promesas antes de volver a intentarlo.',
  'todayProof.promise.delete_status_unavailable':
    'Menta no pudo comprobar si esta promesa se eliminó. Actualiza tus promesas antes de volver a intentarlo.',
  ...
  'todayProof.proof.video_unavailable_short':
    'La prueba en vídeo no está disponible temporalmente.',
  'todayProof.proof.loading_video': 'Cargando prueba de vídeo',
  ...
  'todayProof.promise.cannot_open_video': 'No se pudo abrir el vídeo',
  'todayProof.promise.cannot_open_video_detail':
    'Tu dispositivo no pudo abrir este vídeo de prueba. Inténtalo de nuevo desde la página de promesa.',
  'todayProof.promise.open_video_error':
    'Algo salió mal al abrir este vídeo de prueba. Inténtalo de nuevo en un momento.',
  'todayProof.promise.open_video': 'Abrir prueba de vídeo',
  'todayProof.promise.close_video': 'Cerrar vídeo',
  'todayProof.promise.open_device_player':
    'Abrir en el reproductor del dispositivo',
  'todayProof.promise.open_video_detail': 'Abre este vídeo de prueba',
  'todayProof.promise.device_player_detail':
    'Menta abrirá el vídeo en el reproductor de tu dispositivo para que puedas revisar la prueba.',
  ...
  'todayProof.proof.video_preview': 'Vista previa de prueba de vídeo',
  ...
  'todayProof.proof.saved_detail':
    'Este borrador se guarda en este teléfono. Ábralo cuando esté listo para enviar.',
  ...
  'todayProof.review.opening_video_proof':
    'Apertura de evidencia de prueba de vídeo',
  ...
  'todayProof.review.video_submitted': 'Prueba de vídeo enviada para revisión',
  ...
  'todayProof.streak.queued_detail':
    'La prueba está guardada en este teléfono, pero no se ha enviado. No cuenta hasta que Menta la reciba y la aprueba.',
  ...
  'todayProof.residual.your_draft_stays_on_this_phone_open_menta_when_you_are_online_to':
    'Tu borrador permanece en este teléfono. Abre Menta cuando estés en línea para reanudar el envío.',
  ...
  'todayProof.residual.menta_could_not_confirm_whether_your_proof_was_sent_your_origina':
    'Menta no pudo confirmar si se envió tu prueba. Tu original todavía está guardado en este teléfono. Comprueba tu estado antes de volver a enviar.',
  ...
  'todayProof.correction.title_video': 'Un vídeo más claro y listo.',
  'todayProof.correction.detail_video':
    'Añade un vídeo más claro para terminar hoy.',
  'todayProof.correction.action_video': 'Añade un vídeo más claro',
  ...
  'todayProof.residual.proof_still_saved_on_this_phone':
    'Tu prueba sigue guardada en este teléfono.',
  'todayProof.residual.nothing_saved_on_this_phone_was_changed':
    'No ha cambiado nada de lo guardado en este teléfono.',
