...
export const proofRecoveryFrFR = {
  'proofRecovery.pending.accessibility': 'Preuve en attente de validation',
  'proofRecovery.pending.title': 'Preuve envoyée pour validation',
  'proofRecovery.pending.description':
    'Une personne peut maintenant la comparer à la promesse. La preuve de {promise} comptera après sa validation.',
  'proofRecovery.pending.status': 'En attente de validation',
  ...
  'proofRecovery.queued.description':
    'Elle est enregistrée sur ce téléphone, mais n’est pas encore arrivée dans Menta. Réessayez lorsque vous aurez une connexion.',
  ...
  'proofRecovery.queued.sending': 'Nouvel envoi en cours…',
  'proofRecovery.queued.retry': 'Réessayer l’envoi',
